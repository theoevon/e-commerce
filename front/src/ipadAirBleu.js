    ...
    return(
        <div className='app'>
            ...
            <div className='body_ipad'>
                <div className='left'>
                    <img src="https://cdn.discordapp.com/attachments/973872783320817744/1047511335551897691/ipad-air-select-wifi-blue-202203.png" alt="image_ipad"></img>
                </div>
                <div className='right'>
