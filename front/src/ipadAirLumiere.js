...
const IpadLumiere = () =>{
    return(
        ...
        <div className='body_ipad'>
            <div className='left'>
                <img src="https://cdn.discordapp.com/attachments/973872783320817744/1047511374869303296/ipad-air-select-wifi-starlight-202203.png" alt="image_ipad"></img>
            </div>
            <div className='right'>
