...
const IpadRose = () =>{
    return(
        ...
        <div className='body_ipad'>
            <div className='left'>
                <img src="https://cdn.discordapp.com/attachments/973872783320817744/1047511323702996992/ipad-air-select-wifi-pink-202203.png" alt="image_ipad"></img>
            </div>
            <div className='right'>
