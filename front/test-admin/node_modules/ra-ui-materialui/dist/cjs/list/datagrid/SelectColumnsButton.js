...
var SelectColumnsButton = function (props) {
    ...
    var _b = (0, ra_core_1.useStore)("".concat(preferenceKey, ".availableColumns"), []), availableColumns = _b[0], setAvailableColumns = _b[1];
    var omit = (0, ra_core_1.useStore)("".concat(preferenceKey, ".omit"), [])[0];
    var _c = (0, ra_core_1.useStore)("".concat(preferenceKey, ".columns"), availableColumns
    ...
    return (React.createElement(React.Fragment, null,
        isXSmall ? (React.createElement(material_1.Tooltip, { title: title },
            React.createElement(material_1.IconButton, { "aria-label": title, color: "primary", onClick: handleClick, size: "large" },
                React.createElement(ViewWeek_1.default, null)))) : (React.createElement(StyledButton, { size: "small", onClick: handleClick, startIcon: React.createElement(ViewWeek_1.default, null) }, title)),
